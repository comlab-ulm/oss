...
GBool XRef::okToPrint(GBool ignoreOwnerPW) {
  return ignoreOwnerPW || (!ignoreOwnerPW && ownerPasswordOk) || (permFlags & permPrint);
}

GBool XRef::okToChange(GBool ignoreOwnerPW) {
  return ignoreOwnerPW || (!ignoreOwnerPW && ownerPasswordOk) || (permFlags & permChange);
}

GBool XRef::okToCopy(GBool ignoreOwnerPW) {
  return ignoreOwnerPW || (!ignoreOwnerPW && ownerPasswordOk) || (permFlags & permCopy);
}

GBool XRef::okToAddNotes(GBool ignoreOwnerPW) {
  return ignoreOwnerPW || (!ignoreOwnerPW && ownerPasswordOk) || (permFlags & permNotes);
}
